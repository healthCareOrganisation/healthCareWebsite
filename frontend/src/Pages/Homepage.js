      ...
      <div className='banner'>
        <div className='banner-inside'>
          <div className='up'>
            ...
            <div className='right'>
              <p>
                Live a diabetes-free life <br /> CareConnect
              </p>
              <span>
                <i class='fa-solid fa-pills'></i> Reduce HbA1c{' '}
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <i class='fa-solid fa-heart'></i> No more Medications
              </span>
          ...
          <div className='down'>
            ...
            perferendis velit explicabo illo laborum corporis commodi dolor
            delectus similique impedit!
          </div>
        </div>
      </div>
